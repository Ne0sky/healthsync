...
const About = () => {
  return (
    <div className='w-full p-16 flex flex-row-reverse font-main gap-8 items-center'>
        <div>
        <div className='flex items-center'><h2 className='text-4xl  font-bold py-8'>About HealthSync </h2><span className='w-1/2 block h-[1px] mx-2 bg-zinc-600'></span><span></span></div>
        <p>
